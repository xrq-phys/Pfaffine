...
dmgemm_1wx28:
	...
	whilelo	p0.d, x11, x9	// predicator.
...
//	mov	x10, x10	// x10 itself acts as counter.
	...
	fmad	z28.d, p0/m, z31.d, z13.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 14
	fmad	z28.d, p0/m, z31.d, z14.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 15
	fmad	z28.d, p0/m, z31.d, z15.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 16
	fmad	z28.d, p0/m, z31.d, z16.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 17
	fmad	z28.d, p0/m, z31.d, z17.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 18
	fmad	z28.d, p0/m, z31.d, z18.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 19
	fmad	z28.d, p0/m, z31.d, z19.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 20
	fmad	z28.d, p0/m, z31.d, z20.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 21
	fmad	z28.d, p0/m, z31.d, z21.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 22
	fmad	z28.d, p0/m, z31.d, z22.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 23
	fmad	z28.d, p0/m, z31.d, z23.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 24
	fmad	z28.d, p0/m, z31.d, z24.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 25
	fmad	z28.d, p0/m, z31.d, z25.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 26
	fmad	z28.d, p0/m, z31.d, z26.d
	st1d	z28.d, p0, [x6]
	subs	x10, x10, #1
	madd	x6, x7, x12, x6
	b.eq	END_WRITE_MEM
	ld1d	z28.d, p0/z, [x6]	// column vector 27
	fmad	z28.d, p0/m, z31.d, z27.d
	st1d	z28.d, p0, [x6]
//	subs	x10, x10, #1
//	madd	x6, x7, x12, x6
//	b	END_WRITE_MEM
